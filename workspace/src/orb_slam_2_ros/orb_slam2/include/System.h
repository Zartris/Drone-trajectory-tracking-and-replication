...
public:
    ...
    nav_msgs::Path getGoodKeyFrames(int path_number);

    // Recording path:
    bool getRecordingState();
    void ToggleRecording1();
    void ToggleRecording2();
...
private:
    ...
    int recording = 0;
    long unsigned int start_record_mnId;
    long unsigned int end_record_mnId;
